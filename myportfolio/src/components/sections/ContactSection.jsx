...
const showToast = (message, type) => {
  ...
  return (
    <section
      id="contact"
      className="py-20 px-4 min-h-screen flex items-center justify-center relative overflow-hidden"
    >
      ...
      <div className="relative z-10 w-full max-w-3xl">
        ...
        <div className="bg-white/90 backdrop-blur-md shadow-xl rounded-xl p-10 space-y-6">
          ...
          <div className="flex justify-center gap-6 mb-6 text-gray-700">
            <a href={`mailto:${contact?.email}`} className="hover:text-emerald-500 transition">
              <Mail size={20} />
            </a>
            <a href={`tel:${contact?.phone}`} className="hover:text-emerald-500 transition">
              <Phone size={20} />
            </a>
            <a href={`https://t.me/${contact?.telegram}`} target="_blank" className="hover:text-emerald-500 transition">
              <FaTelegramPlane size={20} />
            </a>
            <a href={`https://github.com/${contact?.github}`} target="_blank" className="hover:text-emerald-500 transition">
              <FaGithub size={20} />
            </a>
            <a href={`https://linkedin.com/in/${contact?.linkedin}`} target="_blank" className="hover:text-emerald-500 transition">
              <FaLinkedin size={20} />
            </a>
          </div>
